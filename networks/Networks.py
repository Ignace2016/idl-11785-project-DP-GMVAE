...
class InferenceNet(nn.Module):
  ...
  def forward(self, x, temperature=1.0, hard=0):
    ...
    # print("mu shape" + str(mu.shape)) 128, 64
    # print("var shape" + str(var.shape)) 128, 64
    # print("gaussian shape" + str(z.shape)) 128, 64
    # print("logits shape" + str(logits.shape)) 128, 10
    # print("prob_cat shape" + str(prob.shape)) 128, 10
    # print("categorical y shape" + str(y.shape)) 128, 10
